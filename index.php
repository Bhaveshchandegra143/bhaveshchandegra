...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@friend's.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 7048177071</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">FRI<span>END'S</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">Founder</a></li>
							...
							<div class="container">
								...
								<h4>FRIEND'S</h4>
									<h3>Stay with friends & families</h3>
										<p>Come & enjoy precious moment with us</p>				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Learn More</a>
			</div>
								</div>	
							</div>
						</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">FRIEND'S</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">MOBILE FOOD</h4>
							<span class="cbp-ig-category">FRIEND'S</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our FRIEND'S</h3> 
						   <p class="about-para-w3ls">NO MATTER HOW NICE A HOTEL IS,IT'S NOT HOME</p>
                           <p class="about-para-w3ls">I RARELY STAY IN HOTEL BECAUSE I HAVE FRIENDS ALL OVER THE WORLD</p>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Consumers expect a safe, convenient, and affordable globalished payment platform.</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>A great restaurant is one that just makes you feel like you're not sure whether you went out ur you come home and confuses you. if it can do both of those things at the same time, you're hooked.</p>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Meet Our Founder</h3>
				  ...
				  <li></li>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>viraj solanki</h4>
							<span>owner</span>
							<p>I PRETEND I'M ONE OF THE ROYAL FAMILY WHEN I'M IN A HOTEL AND THAT THE HOTEL BELONGS TO ME - IT IS A PALACE.</p>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
                ...
                <div class="col-md-3 gallery-grid gallery1">
					<a href="images/v3.jpg" class="swipebox"><img src="images/v3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>FRIEND'S</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7048177071</p>
            <p class="contact-agile1"><strong>whatsapp no. :</strong>+91 9727068762</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@FRIEND'S.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong>kanak road opp.,
            													old power house,
                                                                nr. rajkot municipal corporation,
                                                                karanpara,
                                                                rajkot,
                                                                gujrat 360001</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2019 FRIEND'S . All Rights Reserved | Design by <a href="index.php">VIRAJ</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
